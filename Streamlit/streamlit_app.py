...
with tab_faqs:
            ...
            with expand_faq3:
                    ...
                    <iframe style="border-radius:12px" src="https://open.spotify.com/episode/0jKnJG9pSCNsNsOsoEwNrh?si=f6759e5ccae24142?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                    <br><br>
